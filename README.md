...
## 1. Input Data
- Accepts integer values from the user.
- Stores the values in a 1D list.
...
Shows only those values that are greater than or equal to the entered threshold.
...
[![Watch Video](https://img.shields.io/badge/🎥-Watch_Video-red?style=for-the-badge)](https://drive.google.com/file/d/1QNiNvyZswubb1yU2VeL3GA3bZTJAR23a/view?usp=sharing)
